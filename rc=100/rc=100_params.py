...
bmo  = False #True/False. Include BMO in solution
mantle = False #True/False. Include mantle in solution

#core: development parameters

T_cmb                      = 1680  #Initial temperature of the CMB. Can specify Tcen (temperature at the center of the core) instead. Float.
...
core_solid_density_params  = [6400]  #Inner core density polynomials (radial). List(float)
core_liquid_density_params = [6400]  #Outer core density polynomials (radial). List(float)
ri                         = 0  #Initial inner core radius. Float
r_cmb                      = 100e3  #CMB radius. Float
core_alpha_T_params        = [1e-4]  #Core thermal expansivity pressure polynomial coefficients. List(Float)
core_cp_params             = [733]  #Core specific heat capacity pressure polynomial coefficients. List(Float)
...
P_cmb                      = 8.7e7  #CMB pressure. Float
...
mf_l = [0.1] #(Default None) Starting mole fraction of light element in the core. If specified it will overrule conc_l.
